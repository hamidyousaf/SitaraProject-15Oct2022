...
{
    public class GRNInvoiceViewModel
    {
        ...
        [Display(Name = "Vendor")] [MaxLength(200)] public string Vendor { get; set; }
        [Display(Name = "Vendor")] [MaxLength(200)] public string Address { get; set; }
        [Display(Name = "Transaction Type")] [MaxLength(3)] public string TransactionType { get; set; }
        [Display(Name = "Supplier Inv #")] [MaxLength(50)] public string SupplierInvoiceNo { get; set; }
        ...
        public GRGRNInvoiceDetail[] GRGRNInvoiceDetails { get; set; } 
        public GRGRNInvoice GRGRNInvoices { get; set; }
