...
namespace Numbers.Areas.AR.Controllers
{
    [Area("AR")]
    [Authorize]
    public class CustomerDiscountControllerOld : Controller
    {
        ...
        public CustomerDiscountControllerOld(NumbersDbContext context, ARDiscountRepository ARDiscountRepository, ARDiscountItemRepository ARDiscountItemRepository)
        {
            _dbContext = context;
        ...
        public async Task<IActionResult> Approve(int id)
        {
            ...
            ARDiscount discount = _dbContext.ARDiscount
            ...
            try
            {
                ...
                voucherDetailItem.AccountId = 633;
